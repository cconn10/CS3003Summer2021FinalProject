...
class Operator {
    ...
    final static String INT_POW = "INT**";
    // UnaryOp = !    
    ...
    final static String FLOAT_POW = "FLOAT**";
    // UnaryOp = !    
    ...
    final static String DOUBLE_POW = "DOUBLE**";
    // UnaryOp = !    
    ...
    boolean ArithmeticOp ( ) {
        return val.equals(PLUS) || val.equals(MINUS)
            ...
            || val.equals(INT_POW) || val.equals(FLOAT_PLUS) 
            || val.equals(FLOAT_MINUS) || val.equals(FLOAT_TIMES) 
            || val.equals(FLOAT_DIV) || val.equals(FLOAT_POW)
            || val.equals(DOUBLE_PLUS) || val.equals(DOUBLE_MINUS) 
            || val.equals(DOUBLE_TIMES) || val.equals(DOUBLE_DIV) 
            || val.equals(DOUBLE_POW);
    }
    ...
    final static String intMap[ ] [ ] = {
        ...
        {TIMES, INT_TIMES}, {DIV, INT_DIV}, {POW, INT_POW},
        {EQ, INT_EQ}, {NE, INT_NE}, {LT, INT_LT},
        {LE, INT_LE}, {GT, INT_GT}, {GE, INT_GE},
        {NEG, INT_NEG}, {FLOAT, I2F}, {DOUBLE, I2D}, {CHAR, I2C}
    };

    final static String floatMap[ ] [ ] = {
        {PLUS, FLOAT_PLUS}, {MINUS, FLOAT_MINUS},
        {TIMES, FLOAT_TIMES}, {DIV, FLOAT_DIV}, {POW, FLOAT_POW},
    ...
    final static String doubleMap[ ] [ ] = {
        ...
        {TIMES, DOUBLE_TIMES}, {DIV, DOUBLE_DIV}, {POW, DOUBLE_POW},
